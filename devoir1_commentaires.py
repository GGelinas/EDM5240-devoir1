...
### WOW! :)
### Une «page couverture» en commentaires! :)
...
### Oups! Il fallait conserver la variable publications.
### On pouvait aussi s'en passer.
### Il était en effet possible de la laisser dans un autre fichier appelé «devoir1.py» (que j'ai rajouté à ton répertoire),
#### qu'il était ensuite d'importer avec le code suivant:
...
### Excellente solution! Une première liste de médias de référence qui contient tous les médias qui nous intéressent
...
### Bonne idée!
### Il était cependant possible de faire cela dans ta 3e boucle :)
### Et puis, malheureusement, il en manque toujours un.
### Tu nous dis qu'il y a 3 publications de «Rad», alors qu'il y en a 4, par exemple.
...
### Bravo pour ta solution très élaborée, avec des listes de listes, et très bien documentée!