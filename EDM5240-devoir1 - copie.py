...
### Il était en effet possible de la laisser dans un autre fichier appelé «devoir1.py»,
#### qu'il était ensuite d'importer avec le code suivant:

from devoir1 import publications ### Petit hack sympathique (j'ai rajouté le fichier «devoir1.py» original dans ton répertoire)
